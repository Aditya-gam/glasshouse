...
## Sub-processor list
Cloud LLM · cloud VLM · Clerk (identity) · the hosting/DB/Redis/KMS providers — enumerated in `08-security-privacy/sub-processors.md` and reflected in the DPA/privacy policy.
